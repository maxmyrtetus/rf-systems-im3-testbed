...
- Plot: `docs/plots/base_pre0_navg80_im3_psd_locked.png`

<details>
<summary>Show plot</summary>

![Baseline IM3](docs/plots/base_pre0_navg80_im3_psd_locked.png)
...
- Plot: `docs/plots/saw_pre0_navg80_im3_psd_locked.png`

<details>
<summary>Show plot</summary>

![SAW-only IM3](docs/plots/saw_pre0_navg80_im3_psd_locked.png)
...
- Plot: `docs/plots/saw_lna_pre0_navg80_im3_psd_locked.png`

<details>
<summary>Show plot</summary>

![SAW + LNA IM3](docs/plots/saw_lna_pre0_navg80_im3_psd_locked.png)
...
Plot: `docs/plots/qpsk_ber_vs_snr.png` (generated by `analysis/qpsk_sim_ber.py`)

![QPSK BER vs SNR](docs/plots/qpsk_ber_vs_snr.png)
...
- Correlation / lock view: `docs/plots/qpsk_hw_corr.png`
- Constellation view: `docs/plots/qpsk_hw_constellation.png`

<details>
<summary>Show hardware correlation + constellation plots</summary>

![QPSK HW correlation](docs/plots/qpsk_hw_corr.png)

![QPSK HW constellation](docs/plots/qpsk_hw_constellation.png)
